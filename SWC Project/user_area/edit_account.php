<?php
    ...
    if(isset($_GET['edit_account'])){
        ...
        if(isset($_POST['user_update'])){
            ...
            user_address='$user_address', user_mobile='$user_mobile' where user_id=$user_id";
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="text-center">
        ...
        <div class="form-outline mb-4 d-flex w-50 m-auto">
            ...
            <img src="./user_images/<?php echo $user_img ?>" alt="User Image" class="edit_img">
        </div>
        <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
            <input type="submit" value="Update" class="bg-info py-2 px-3 boder-0" name="user_update">
        </div>
    </form>
</body>
</html>